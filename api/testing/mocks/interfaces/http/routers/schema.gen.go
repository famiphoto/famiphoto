...
// Source: interfaces/http/routers/schema.gen.go
...
import (
	...
	routers "github.com/famiphoto/famiphoto/api/interfaces/http/routers"
...
func (m *MockServerInterface) GetPhotos(ctx echo.Context, params routers.GetPhotosParams) error {
	m.ctrl.T.Helper()
