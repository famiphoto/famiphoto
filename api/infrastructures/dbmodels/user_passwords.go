...
var UserPasswordWhere = struct {
	...
	UserID:         whereHelperint{field: "`user_passwords`.`user_id`"},
...
func FindUserPassword(ctx context.Context, exec boil.ContextExecutor, userID int, selectCols ...string) (*UserPassword, error) {
...
func UserPasswordExists(ctx context.Context, exec boil.ContextExecutor, userID int) (bool, error) {
	var exists bool
