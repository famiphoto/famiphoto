...
func (o *Photo) GetPhotoFiles() PhotoFileSlice {
	if o == nil {
		return nil
	}

	return o.R.GetPhotoFiles()
}
...
func (o *Photo) GetPhotosPhotoTags() PhotosPhotoTagSlice {
	if o == nil {
		return nil
	}
...
var (
	photoAllColumns            = []string{"photo_id", "name", "file_name_hash", "created_at", "updated_at"}
	photoColumnsWithoutDefault = []string{"photo_id", "name", "file_name_hash"}
